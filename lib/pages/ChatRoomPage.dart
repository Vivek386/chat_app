...
class ChatRoomPage extends StatefulWidget {
  ...
  const ChatRoomPage({Key? key, required this.userModel, required this.firebaseUser,required this.targetUser,required this.chatRoom}) : super(key: key);
...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  void sendMessage()async{
    ...
    widget.chatRoom.chatDateTime = DateTime.now();
      ...
      appBar: AppBar(
          title: Row(
            children: [
              ...
              SizedBox(width: 10,),
              Text(widget.targetUser.fullname.toString(),style: TextStyle(fontWeight: FontWeight.w600),),
            ],
          ),
      ),
      body: SafeArea(
                    ...
                    builder: (context,snapshot){
                      if(snapshot.connectionState == ConnectionState.active){
                        if(snapshot.hasData){
                          ...
                          return Center(child: Text("An error occured ,kindly check your internet connection!"),);
                        }else{
                          return Center(
